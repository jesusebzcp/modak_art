...
import static com.jebzcpcalendar.Utils.doesEventExist;
import static com.jebzcpcalendar.Utils.extractLastEventId;
import static com.jebzcpcalendar.Utils.getTimestamp;


@ReactModule(name = RNAddCalendarModule.NAME)
public class RNAddCalendarModule extends ReactContextBaseJavaModule implements ActivityEventListener, LoaderManager.LoaderCallbacks  {
    public static final String NAME = "RNAddCalendar";
    ...
    public RNAddCalendarModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void onLoadFinished(Loader loader, Object data) {
        ...
        if (cursor.isClosed()) {
            Log.d(NAME, "cursor was closed; loader probably wasn't destroyed previously (destroyLoader() failed)");
    ...
    private void returnResultBackToJS(@Nullable Long eventPostId) {
        if (promise == null) {
            Log.e(NAME, "promise is null");
            return;
        }

        if (eventPriorId == null || eventPostId == null) {
            promise.reject(NAME, "event prior and/or post id were null, extractLastEventId probably encountered a problem");
        } else {
    ...
    private void destroyLoader(Loader loader) {
        ...
        if (activity != null) {
            ...
            Log.d(NAME, "activity was null when attempting to destroy the loader");
        }
    }
