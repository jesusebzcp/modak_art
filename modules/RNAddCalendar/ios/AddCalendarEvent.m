#import "RNAddCalendar.h"
#import "EKEventStoreSingleton.h"

@interface RNAddCalendar()
...
static NSString *const MODULE_NAME= @"RNAddCalendar";
...
{
    RNAddCalendar * __weak weakSelf = self;
